      ...
      <div className="flex flex-col md:flex-row gap-10 flex-wrap">
        ...
        <article className="flex flex-col gap-7 flex-1">
          ...
          <p className="text-gray-600">
            ...
            Aspernatur autem expedita accusamus labore voluptatibus quae numquam
            explicabo, totam dolores atque repudiandae ad aut, alias earum est
            rem laboriosam neque! Earum adipisci est beatae modi at explicabo
            nisi dolorem cupiditate sed vero illum, fuga, culpa ad ut velit?
            Rem.
          </p>
        </article>
      </div>
